...
hidden if the `SimpleAmqpClient_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `SimpleAmqpClient_DEVELOPER_MODE` to the configure
